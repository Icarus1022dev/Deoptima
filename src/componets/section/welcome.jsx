...
export const Welcome = () => {
    ...
    return <StyledWelcome className="container">
        ...
        >
            ...
            <StyledInputBtn>
                <StyledInput onChange={handleChange} name='email' type="email" placeholder="Your business email..." onClick={handleClick} />
                ...
                {/* <BtnBlue onClick={() => submit(email)} >Free trial</BtnBlue> */}
            </StyledInputBtn>
            <StyledWelInputBug>
                {
                    temp &&
